from greedy_randomized import generate_most_similar_text
...
def _generate_file_name_from(problem_instance_file_path):
    ...
    file_name_from_problem_instance_file_path = problem_instance_file_path.split("/")[2]
...
def grasp(problem_instance_file_path):
    ...
    while iterations_without_improvement < 200 and iteration < 500:
